            ...
            ? Center(
                ...
                children: [
                  ...
                  const Text(
                    'Покупка совершена',
                    style: TextStyle(
                        fontSize: 16.0, color: Color.fromARGB(255, 3, 124, 5)),
                  ),
                ],
              ))
                                        ...
                                        children: [
                                          SlidableAction(
                                            onPressed: (context) async {
                                              ...
                                              if (answer == true) {
                                                Items new_item = Items(
                                                    id: UpdatedItemsFromCart.elementAt(index)
                                                        .id,
                                                    name: UpdatedItemsFromCart.elementAt(index)
                                                        .name,
                                                    image: UpdatedItemsFromCart
                                                            .elementAt(index)
                                                        .image,
                                                    cost: UpdatedItemsFromCart.elementAt(index)
                                                        .cost,
                                                    describtion:
